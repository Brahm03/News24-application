...
class Api {
  ...
  static String apiapple =
      'https://newsapi.org/v2/everything?q=apple&from=2022-03-16&to=2022-03-16&sortBy=popularity&apiKey=$api_key';
  static String apitestla =
      'https://newsapi.org/v2/everything?q=tesla&from=2022-02-17&sortBy=publishedAt&apiKey=$api_key';
